...
function aplicarParametrosOperativos(datos: DatosHub, hub?: HubPublico): DatosHub {
  ...
  return { ...datos, actores, resumen: { ...datos.resumen, observacionGeneral: datos.resumen.observacionGeneral || "La ficha del Hub define las reglas base del servicio. Los parámetros no son gastos del día." } };
}
