...
export const BRANCHES: BranchConfig[] = [
  {
    ...
    description: "Rama para JardinerosYa, espacios verdes, mantenimiento de jardines, horas de trabajo, maquinaria, jardineros, visitas y distribución estimada.",
    status: "activa",
    icon: "🌿",
    color: "#1E8F4D",
  ...
  },
  {
    ...
    description: "Rama preparada para fumigación: empresas o técnicos, establecimientos, certificados, vencimientos, productos aplicados, trampas, historial y cobertura técnica.",
    status: "preparada",
    icon: "🛡️",
    color: "#8A4F00",
  ...
  },
  {
    ...
    slug: "ventas",
    name: "Ventas",
    description: "Rama preparada para productos, pedidos, cajas o unidades, repartos, recorridos, entregas, clientes recurrentes, cobros y reportes de venta/reparto.",
    status: "preparada",
    icon: "📦",
    color: "#B45309",
