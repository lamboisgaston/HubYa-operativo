...
export async function enviarPruebaMensajeDesdeInput(input: EnviarPruebaMensajeInput) {
  ...
  const timestamp = new Date().toISOString();
  const cliente: Cliente = { id: "prueba", nombre: "Email de prueba", email: emailPrueba, whatsapp: "", tarifaCliente: "sin_tarifa", hubId: "prueba", tipoDestino: "cliente", estado: "activo", createdAt: timestamp, updatedAt: timestamp };
