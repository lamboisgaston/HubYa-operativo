...
export type EnviarPruebaMensajeInput = { asunto: string; mensaje: string; emailPrueba: string; acercaDeHubYa?: string; opcionesRespuesta?: string[]; baseUrl?: string };
