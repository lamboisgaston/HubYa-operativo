...
export type Cliente = { id: string; nombre: string; email: string; whatsapp: string; referencia?: string; tarifaCliente: TarifaClienteHub; hubId: string; tipoDestino: TipoDestinoContacto; estado: "activo" | "inactivo"; createdAt: string; updatedAt: string };
