...
import { getClientesByHubId, getReportesPorHub } from "@/lib/data/hubs";
  ...
  return (
    <main className="min-h-screen bg-[#f6f7f2] px-4 py-6 text-[#1f2a1d]">
      <div className="mx-auto grid max-w-7xl gap-5">
        <HubNav hub={hub} active="reportes" />
        <OperativoLegacy initialSection="reporte" initialHubName={hub.nombre} initialClientes={clientes} initialHub={hub} initialReportes={reportes} simpleMode />
      </div>
    </main>
  );
}
